                        ...
                        <div class="col-lg-12">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2" value="option2">PDF (.pdf)
                                    </label>
                                ...
                                <button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-export"></i> Export</button>
