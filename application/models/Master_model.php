...
class Master_model extends CI_Model {
   ...
   function get_ref_kolom(){
    ...
    function getDetilTempUpload(){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN  :RetVal := PEMADANAN.PKG_UPLOAD.GET_DETIL_UPLOAD_TEMP(:p_id_upload, :p_nama_table, :p_start, :p_lenght, :p_sort_by, :p_sort_dir, :p_search); END;');
