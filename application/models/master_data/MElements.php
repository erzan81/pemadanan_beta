...
class MElements extends CI_Model {
   ...
   function get_ref_element(){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN  :RetVal := PEMADANAN.PKG_MASTER.GET_REF_ELEMENT; END;');
   ...
   public function ins_element($save){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN PEMADANAN.PKG_MASTER.INS_ELEMENT(:p_id_element, :p_tipe_kolom, :p_size_kolom, :p_keterangan, :p_create_by, :out_rowcount, :msgerror); END;');
   ...
   public function upd_element($save){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN PEMADANAN.PKG_MASTER.UPD_ELEMENT(:p_id_element, :p_tipe_kolom, :p_size_kolom, :p_keterangan, :p_create_by, :out_rowcount, :msgerror); END;');
    ...
    public function del_element($save){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN PEMADANAN.PKG_MASTER.DEL_ELEMENT(:p_id_element, :p_create_by, :out_rowcount, :msgerror); END;');
