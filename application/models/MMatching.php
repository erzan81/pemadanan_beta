...
class MMatching extends CI_Model {
   ...
   function get_kolom_pemadanan($id_upload){
    ...
    public function metode_pemadanan($save){
        ...
        $stid = oci_parse($this->pblmig_db->conn_id, 'BEGIN PEMADANAN.PKG_PEMADANAN.METODE_PEMADANAN(:p_instansi_id, :p_id_upload, :p_id_kolom, :p_is_proses, :p_is_digit, :p_metode, :p_nilai, :p_atribut, :p_digit, :p_create_by, :out_rowcount, :msgerror); END;');
